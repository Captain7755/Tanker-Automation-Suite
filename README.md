...
* ♻️ **Garbage Calculation Tool** — Автоматизированный расчет объемов мусора по категориям MARPOL Annex V. Позволяет точно планировать сдачу отходов в зависимости от количества экипажа и дней перехода.
---
